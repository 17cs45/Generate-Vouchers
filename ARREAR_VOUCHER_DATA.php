...
<head>
    ...
    <title>ARREAR VOUCHER DATA</title>
      <!--jQuery-->
...
<?php
    ...
    else
    {
        ...
        $STATEMENT_INSERT_INTO_CB_VOUCHER = oci_parse($cb_conn,$OBJECT_VOUCHER->InsertintoCBVoucherArrear($VOUCHER_NUMBER,$EMP_AREA_CODE, $EMP_REG_SERIAL_NO, $EMP_SUB_AREA_CODE, 
        $EMP_SUB_SERIAL_NO, $F_DATE, $T_DATE,$_SESSION['Statuatorry_increase'], $TOTAL_AFTER_DUE, 
        ...
        if((oci_num_rows($STATEMENT_INSERT_INTO_CB_VOUCHER) > 0) and (oci_num_rows($STATEMENT_INSERT_INTO_CB_VOUCHER_TYPE) > 0))
        {
            ...
            <script type='text/javascript'>
                ...
                window.open('GenerateVoucherArrear.php');
            </script>
            ";
        }
        else
