<?php
    ...
    class PDF extends FPDF
    {
        function Header()
        {
            ...
            $this->Image('./imgs/PaymentSlip/arrearsContribution_header.jpg', 0, 65,160);
            ...
            $this->SetTextColor(0,0,0);
            $this->SetFont('Times','B',10);
            $text= 'RS : '.($_SESSION['EMPLOYERS_CONTRIBUTION']+$_SESSION['EMPLOYEE_CONTRIBUTION']+$_SESSION['Statuatorry_increase']);
            $this->Write(0,$text);
    ...
    $url = './Archive/PR03_'.$_SESSION['REGISTRATION_NO'].$_SESSION['SUB_CODE'].'_DATED '.$_SESSION['CONTR_MONTH_FROM'].' To '.$_SESSION['CONTR_MONTH_TO'].'_ARREARS_DEMAND.pdf';

    // $url = './Archive/PR03_'.$_SESSION['REGISTRATION_NO'].'_ARREARS_DEMAND.pdf';
    $pdf->Output($url,'F');
