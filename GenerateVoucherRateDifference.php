<?php
    ...
    class PDF extends FPDF
    {
        function Header()
        {
            ...
            $this->Image('./imgs/PaymentSlip/RateDiffContribution_header.jpg', 0, 65,160);
    ...
    $url = './Archive/PR03_'.$_SESSION['REGISTRATION_NO'].$_SESSION['SUB_CODE'].'_DATED '.$_SESSION['CONTR_MONTH_FROM'].' To '.$_SESSION['CONTR_MONTH_TO'].'_RATEDIFF_DEMAND.pdf';

    // $url = './Archive/PR03_'.$_SESSION['REGISTRATION_NO'].'_RATEDIFF_DEMAND.pdf';
    $pdf->Output($url,'F');
