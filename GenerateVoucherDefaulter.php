<?php
    ...
    class PDF extends FPDF
    {
        function Header()
        {
            ...
            // ======================ARREAR CONTRIBUTION SECTION START====================

            $this->Image('./imgs/PaymentSlip/Demand_contribution.jpg', 0, 65,160);
            ...
            $this->SetTextColor(0,0,0);
            $this->SetFont('Times','B',10);
            $text= $_SESSION['EMPLOYERS_CONTRIBUTION'];
            $this->Write(0,$text);
            ...
            $this->SetTextColor(0,0,0);
            $this->SetFont('Times','B',10);
            $text= $_SESSION['Statuatorry_increase'];
            $this->Write(0,$text);
            ...
            $this->SetTextColor(0,0,0);
            $this->SetFont('Times','B',10);
            $text= $_SESSION['EMPLOYEE_CONTRIBUTION'];
            $this->Write(0,$text);
            ...
            $this->SetTextColor(0,0,0);
            $this->SetFont('Times','B',10);
            $text= $_SESSION['EMPLOYERS_CONTRIBUTION']+$_SESSION['EMPLOYEE_CONTRIBUTION'];
            $this->Write(0,$text);
            ...
            $this->SetTextColor(0,0,0);
            $this->SetFont('Times','B',10);
            $text= $_SESSION['Statuatorry_increase']+$_SESSION['EMPLOYERS_CONTRIBUTION']+$_SESSION['EMPLOYEE_CONTRIBUTION'];
            $this->Write(0,$text);
            ...
            $this->SetTextColor(0,0,0);
            $this->SetFont('Times','B',10);
            $text= $_SESSION['CONTRIBUTION_MONTH_FROM'];
            $this->Write(0,$text);
    ...
    $url = './Archive/PR03_'.$_SESSION['REGISTRATION_NO'].$_SESSION['SUB_CODE'].'_DATED '.$_SESSION['CONTR_MONTH_FROM'].' To '.$_SESSION['CONTR_MONTH_TO'].'_DEFAULTER.pdf';
    // $url = './Archive/PR03_'.$_SESSION['REGISTRATION_NO'].'_DEFAULTER.pdf';
    $pdf->Output($url,'F');
